# Bash Program To display the result a student has scored (same as 5th program) using case...esac statement. 

# Multiple Students wach with 5 subjects

echo "Enter the number of students: "
read numberOfStudents

if [ $numberOfStudents -lt 0 ]
then
    echo "Invalid Input"
    exit
fi
